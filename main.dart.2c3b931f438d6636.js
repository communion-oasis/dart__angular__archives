...
p.p(p.f)
r=T.bf(n,p.f,"img")
T.bN(r,"src","packages/archives/src/components/header/resources.lFdjCCyDHB68S/logo.png")
p.M(r)
q=T.a2(n,m)
p.u(q,"header")
p.p(q)
